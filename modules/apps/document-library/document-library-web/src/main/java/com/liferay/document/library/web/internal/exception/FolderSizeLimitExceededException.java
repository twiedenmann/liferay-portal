...
public class FolderSizeLimitExceededException extends PortalException {
	...
	public FolderSizeLimitExceededException(String msg) {
		super(msg);
	}

	public FolderSizeLimitExceededException(String msg, Throwable throwable) {
		super(msg, throwable);
	}

	public FolderSizeLimitExceededException(Throwable throwable) {
		super(throwable);
	}
