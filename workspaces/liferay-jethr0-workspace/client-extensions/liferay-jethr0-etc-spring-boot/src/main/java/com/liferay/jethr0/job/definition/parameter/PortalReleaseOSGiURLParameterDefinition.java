 ...
 */
public class PortalReleaseOSGiURLParameterDefinition
	extends BaseJobParameterDefinition {

	@Override
	public String getKey() {
		return "portalReleaseOSGiURL";
	}

	@Override
	public String getLabel() {
		return "Portal Release OSGi URL";
	}
	...
	public String getValueDescription() {
		return StringUtil.combine(
			...
			"/2023.q4.0-1701199535/liferay-dxp-osgi-2023.q4.0-1701199535.zip");
	}
